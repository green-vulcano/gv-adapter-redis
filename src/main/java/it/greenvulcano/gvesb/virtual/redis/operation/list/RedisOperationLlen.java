...
public class RedisOperationLlen extends RedisOperation {
    ...
    public static final String TYPE = "llen";

    public RedisOperationLlen() {
        super(TYPE);
    }
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {    
        ...
        Long result = redisConnection.llen(key);
        
        gvBuffer.setProperty("REDIS_"+TYPE.toUpperCase()+"_REPLY", result.toString());
