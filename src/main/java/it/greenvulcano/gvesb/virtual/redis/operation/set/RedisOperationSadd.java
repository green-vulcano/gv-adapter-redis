...
public class RedisOperationSadd extends RedisOperation {
    ...
    public static final String TYPE = "sadd";

    public RedisOperationSadd() {
        super(TYPE);
    }
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {
    	...
    	String result = redisConnection.sadd(key, gvBuffer.getObject().toString()).toString();
