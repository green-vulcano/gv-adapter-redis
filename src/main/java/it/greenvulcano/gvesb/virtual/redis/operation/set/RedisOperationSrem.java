...
public class RedisOperationSrem extends RedisOperation {
    ...
    public static final String TYPE = "srem";

    public RedisOperationSrem() {
        super(TYPE);
    }
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {  
    	...
    	String result = redisConnection.srem(key, gvBuffer.toString()).toString();
