 ...
 *******************************************************************************/
package it.greenvulcano.gvesb.virtual.redis.operation.string;
...
public class RedisOperationSet extends RedisOperation {
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {
    	...
    	String result = redisConnection.set(key, gvBuffer.getObject().toString()).toString();
