 ...
 *******************************************************************************/
package it.greenvulcano.gvesb.virtual.redis.operation.hash;
...
public class RedisOperationHset extends RedisOperation {
    ...
    public static final String TYPE = "hset";
    
    private final String hashKey;

    public RedisOperationHset(String hashKey) {
        super(TYPE);
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {
        gvBuffer.setProperty("REDIS_HSET_REPLY", redisConnection.hset(key, hashKey, gvBuffer.getObject().toString()).toString());
        
    	String result = redisConnection.hset(key, hashKey, gvBuffer.getObject().toString()).toString();
    ...
    public static class Builder implements RedisOperation.RedisOperationBuilder {
        ...
        public RedisOperation build(Node operationNode) throws XMLConfigException {
            ...
            return new RedisOperationHset(configuredField);
        }
