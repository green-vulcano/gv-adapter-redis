...
public class RedisOperationHdel extends RedisOperation {
    
    public static final String TYPE = "hdel";

    public RedisOperationHdel() {
        super(TYPE);
    }
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {
    	...
    	String result = redisConnection.hdel(key).toString();
