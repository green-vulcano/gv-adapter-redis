...
public class RedisOperationSunion extends RedisOperation {
    
    public static final String TYPE = "sunion";

    public RedisOperationSunion() {
        super(TYPE);
    }
    ...
    public void perform(Jedis redisConnection, String key, GVBuffer gvBuffer) throws GVException {
    	...
    	String result = redisConnection.sunion(key, gvBuffer.getObject().toString()).toString();
    ...
    public static class Builder implements RedisOperation.RedisOperationBuilder {
        ...
        public RedisOperation build(Node operationNode) throws XMLConfigException {            
            return new RedisOperationSunion();
        }
